...
<head>
    ...
    <link rel="app  le-touch-icon" sizes="144x144" href="img/favicon/apple-icon-144x144.png">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="#kriterien">Auswahlkriterien</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <form action="#secAuswertung" method="POST">
                    <h1>Auswahlkriterien</h1>
                    ...
                    <div id="suchbegriffe" style="display:none;">
                        ...
                        <input id="submit" class="btn btn-primary" type="submit" name="submit" value="Anzeigen" style="margin-top: 5%; margin-left: 80%;">
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                if (($GLOBALS['notSet']) == false) {
                    echo "<p class='lead'>Folgende Auswahl trifft auf folgende Kriterien zu:</p>";

                    $suche = "";

                    // Auflistung der Kriterien
                    if (isset($_POST['jaAnteil_1']) || isset($_POST['jaAnteil_2'])){
                        echo "<p class='lead'><strong>Jahr:</strong> $gesJahr_1 - $gesJahr_2</p>";
                    }
                    if (isset($_POST['stimmbeteiligung_1']) || isset($_POST['stimmbeteiligung_2'])) {
                        echo "<p class='lead'><strong>Stimmbeteiligung:</strong> $stimmbeteiligung_1 - $stimmbeteiligung_2%</p>";
                    }
                    if (isset($_POST['jaAnteil_1']) || isset($_POST['jaAnteil_2'])) {
                        echo "<p class='lead'><strong>Ja-Anteil:</strong> $jaAnteil_1 - $jaAnteil_2%</p>";
                    }
                    if (isset($_POST['abstimmungArt'])) {
                        echo "<p class='lead'><strong>Abstimmungsart:</strong> $abstimmungsart_1</p>";
                    }
                    if ($suchbegriff_1 != "") {
                        echo "<p class='lead'><strong>Suchbegriff:</strong> $suchbegriff_1</p>";
                    }
                }
                    ...
                    echo "
                      <div class=\"panel-group\">
                          <div class=\"panel panel-default\">
                            ...
                            <div id=\"gesamtdurchschnitt\" class=\"panel-collapse\">
                              <div class=\"panel-body\">
                              <table class=\"table-borderless\">                            
                                  <thead>
                                    <tr>
...
<script type="text/javascript">
    ...
    // Zeichnen und Variablen festsetzen
    function drawChart() {
        ...
        var options = {'width': '600', 'height': '300', 'backgroundColor': 'transparent'};
